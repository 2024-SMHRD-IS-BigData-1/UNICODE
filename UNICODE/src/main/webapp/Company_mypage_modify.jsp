...
<body>
        ...
        <div class="profile-box-wrapper" style="display: flex; justify-content: space-between; align-items: center;">
            <div style="display: flex; align-items: center; height: 180px;">
                <div class="profile-img">
                    <img class="user-img" src="/img/포켓몬4.jpg" alt="프로필 이미지" style="cursor: pointer; width: 100%;">
                    <!-- 숨겨진 파일 선택 input -->
                    <input type="file" id="fileInput" style="display: none;" />
                </div>
                <div style="padding: 20px;">
                    <div class="profile-title">
                        <input class="profile-username" type="text" value="company"></input> <!-- value값은 원래 저장되어 있던 사용자 이름 --> 
                    </div>
                </div>
            </div>
            <div id="header-button" >
                <a href="Company_mypage.jsp">
                        ...
                        <div style="padding: 0 30px; margin-top: 30px;">
                            ...
                            <div style="margin-bottom: 17px;">
                                <div class="end-period">
                                    <input type="text" name="" placeholder="종료일" style="font-size: smaller; width: 150px;">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="assets/js/profile_img_modify.js"></script>
</body>
</html>